...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/avagreyyy4/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |           7m31s           |           46s             | 
| `pg_normalized_batch`  |           3m22s           |           18.2s           | 
| `pg_denormalized`      |            23s            |           3.5s            | 
